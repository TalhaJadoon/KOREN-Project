  ...
  <body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="#">
        Intent Portal&emsp;&emsp;&emsp;&emsp;
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#">Current Intents <span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="row py-5 text-center">
        <table class="table table-hover table-striped">
          ...
          <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
              <th scope="col" class="text-left">IntentID</th>
              <th scope="col">servicename</th>
              <th scope="col">QoS</th>
              <th scope="col">ClientNode</th>
              ...
              if($conn->connect_error) {
                ...
                if ($result2->num_rows > 0) {
                    ...
                    while($row = $result2->fetch_assoc()) {
                        $iconClass = ($row['status']==1?'fa-check-square text-success':'fa-refresh text-warning');
                        $iconTitle = ($row['status']==2?'synced':'to be synced');
                        echo  '<tr>'
                          .     '<th scope="row">' . ++$ijk . '</th>'
                          .     '<td class="text-left">' . $row['Intentid'] . '</td>'
                          .     '<td class="text-left">' . $row['servicename'] . '</td>'
                          .     '<td class="text-left">' . $row['QoSType'] . '</td>'
                          .     '<td class="text-left">' . $row['ClientNodeName'] . '</td>'
                          .     '<i class="fa fa-sm ' . $iconClass . '" title="' . $iconTitle . '"></i>'
                          .     '<td><a class="badge badge-light" href="graph.php?id=' . $row['Intentid'] . '">graph</a></td>'
                          .     '<td>'
                          .   '</tr>';
      ...
      <footer class="my-5 pt-5 text-muted text-center text-small">
        ...
        <ul class="list-inline">
          ...
          <li class="list-inline-item"><a href="http://220.149.42.102/ncl427/#profile-talha">Developer</a></li>
